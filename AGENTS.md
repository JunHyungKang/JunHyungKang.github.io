...
- When a requested or existing SVG teaser accompanies a LinkedIn post, keep the SVG as the source and attach its verified raster rendition. Confirm the intended media preview in the composer before publishing; treat missing media as a blocker because LinkedIn text editing may not allow media to be added afterward.
